...
{
    public class RavenServerController<TServerLocator> : IDisposable
        where TServerLocator : RavenServerLocator, new()
    {
        ...
        public IDocumentStore GetDocumentStore(string database = null, TimeSpan? waitForIndexingTimeout = null)
        {
        ...
        private static void ReportInfo(string message)
        {
            ...
            Report($"{DateTime.Now}: {message}\r\n");
        }

        private static void Report(string msg)
        {
            File.AppendAllText("raven_embedded.log", msg);
